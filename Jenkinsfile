...
try {
    ...
    node {
        ...
        dbPassword = getAwsParameter("/${env.ENV}/porsgresql/POSTGRES_PASSWORD")
        dbUser = getAwsParameter("/${env.ENV}postgresql/POSTGRES_USER")
        dbPort = getAwsParameter("/${env.ENV}postgresql/POSTGRES_PORT")
